...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    i.VERSION = "3.3.6", i.TRANSITION_DURATION = 1400, i.DEFAULTS = {
        interval: 5e3,
        pause: "hover",
        wrap: !0,
        keyboard: !0
    ...
    i.VERSION = "3.3.6", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                r = "bottom" == r && d.bottom + c > f.bottom ? "top" : "top" == r && d.top - c < f.top ? "bottom" : "right" == r && d.right + p > f.width ? "left" : "left" == r && d.left - p < f.left ? "right" : r, s.removeClass(u).addClass(r)
            }
    ...
    e.VERSION = "3.3.6", e.DEFAULTS = {
        ...
        var e = this,
            ...
            o = 0;
        this.offsets = [],
            this.targets = [], this.scrollHeight = this.getScrollHeight(), t.isWindow(this.$scrollElement[0]) || (i = "position", o = this.$scrollElement.scrollTop()), this.$body.find(this.selector).map(function() {
                var e = t(this),
...
! function(e, t) {
    ...
    function t(e) {
        var t, o, i, n, r, s, a, d = {};
        for (a = 0, s = (r = e.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",").split(",")).length; a < s && (-1 === (o = r[a]).search(/^(http|https|ftp):\/\//) && -1 !== o.search(":")); a++) t = o.indexOf(":"), i = o.substring(0, t), (n = o.substring(t + 1)) || (n = void 0), "string" == typeof n && (n = "true" === n || "false" !== n && n), "string" == typeof n && (n = isNaN(n) ? n : +n), d[i] = n;
        return null == i && null == n ? e : d
    }
    ...
    function i(t, o) {
        ...
        e('<img src="' + t + '.jpg">').on("load", i), e('<img src="' + t + '.png">').on("load", i)
    }

    function n(o, i, n) {
        if (this.$element = e(o), "string" == typeof i && (i = t(i)), n ? "string" == typeof n && (n = t(n)) : n = {}, "string" == typeof i) i = i.replace(/\.\w*$/, "");
        else if ("object" == typeof i)
            for (var s in i) i.hasOwnProperty(s) && (i[s] = i[s].replace(/\.\w*$/, ""));
        this.settings = e.extend({}, r, n), this.path = i;
        try {
            this.init()
        } catch (e) {
            if (e.message !== p) throw e
        }
    }
    var r = {
            volume: 1,
        ...
        s = /iPad|iPhone|iPod/i.test(navigator.userAgent),
        a = /Android/i.test(navigator.userAgent),
        d = /Windows Phone/i.test(navigator.userAgent),
        p = "Not implemented";
    n.prototype.init = function() {
        var t, n, r = this,
            ...
            f = o(g.position),
            h = g.posterType;
        if (n = r.$wrapper = e("<div>").addClass(g.className).css({
                position: "absolute",
                "z-index": -1,
                top: 0,
                left: 0,
            ...
            }), "object" == typeof c && (c.poster ? u = c.poster : c.mp4 ? u = c.mp4 : c.webm ? u = c.webm : c.ogv && (u = c.ogv)), "detect" === h ? i(u, function(e) {
                n.css("background-image", "url(" + e + ")")
            }) : "none" !== h && n.css("background-image", "url(" + u + "." + h + ")"), "static" === l.css("position") && l.css("position", "relative"), l.prepend(n), !s && !a && !d) {
            "object" == typeof c ? (c.mp4 && (v += '<source src="' + c.mp4 + '.mp4" type="video/mp4">'), c.webm && (v += '<source src="' + c.webm + '.webm" type="video/webm">'), c.ogv && (v += '<source src="' + c.ogv + '.ogv" type="video/ogg">'), t = r.$video = e("<video>" + v + "</video>")) : t = r.$video = e('<video><source src="' + c + '.mp4" type="video/mp4"><source src="' + c + '.webm" type="video/webm"><source src="' + c + '.ogv" type="video/ogg"></video>');
            try {
                t.prop({
                    autoplay: g.autoplay,
                    loop: g.loop,
                    volume: g.volume,
                    muted: g.muted,
                    defaultMuted: g.muted,
                    playbackRate: g.playbackRate,
                    defaultPlaybackRate: g.playbackRate
                })
            } catch (e) {
                throw new Error(p)
            }
        ...
        var i;
        return this.each(function() {
            (i = e.data(this, "vide")) && i.destroy(), (i = new n(this, t, o)).index = e.vide.lookup.push(i) - 1, e.data(this, "vide", i)
        }), this
